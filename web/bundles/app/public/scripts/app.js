...
(function() {
  ...
  define('models/user', function() {
    ...
    return UserModel = (function(superClass) {
      ...
      UserModel.prototype.url = "/process-form";

      UserModel.prototype.parse = function(response) {
        var attr, attrName, parsed, valueObj;
        parsed = {};
        for (attrName in response) {
          valueObj = response[attrName];
          attr = attrName.replace(/\]\[/g, ".").replace(/\[|\]/g, "").split(".");
          _.reduce(attr, function(parsedCurrent, attrCurrent, index) {
...
(function() {
  ...
  define('views/user/edit', ['vent'], function(vent) {
    var UserEditView;
    return UserEditView = (function(superClass) {
      ...
      UserEditView.prototype.template = "#templates-user-edit";

      UserEditView.prototype.templateHelpers = {
        ...
        gender: function(currentValue, checkedValue) {
      ...
      UserEditView.prototype.modelEvents = {
        "sync": "render"
      };

      UserEditView.prototype.validator = null;

      UserEditView.prototype.validatationOptions = {
        rules: {
          "user[userName]": {
            required: true
          },
        ...
        errorPlacement: function(error, element) {
          return error.insertBefore(element.prev("label"));
        }
      };

      UserEditView.prototype.initialize = function() {
        return this.model.set($("#app").data("user"));
      };

      UserEditView.prototype.onRender = function() {
        return this.validator = this.$("form").validate(this.validatationOptions);
      };

      UserEditView.prototype.cancel = function(e) {
        e.preventDefault();
        return vent.trigger("router:navigate", e.currentTarget.pathname);
      };
      ...
      UserEditView.prototype.save = function(e) {
        ...
        data.user.userBirthday = this._prepareBirthday(data.user.userBirthday);
        return this.model.fetch({
          data: data,
          method: "POST",
          success: (function(_this) {
            return function() {
              return vent.trigger("router:navigate", "/");
            };
          })(this),
          error: (function(_this) {
            return function(user, xhr) {
              return _this._showErrors(xhr.responseJSON.errors.children);
            };
          })(this)
        });
      };

      UserEditView.prototype.toggleLabel = function(e) {
        var formGroup;
        formGroup = this.$(e.currentTarget).parents(".form-group");
        if (formGroup.hasClass("has-error")) {
          return;
        }
        return this.$(e.currentTarget).prev("label").toggleClass("invisible", e.type === "focusout");
      };

      UserEditView.prototype._prepareBirthday = function(birthday) {
        var date;
        if (!birthday) {
          return;
        }
      ...
      UserEditView.prototype._showErrors = function(errors) {
        var attr, error, obj, results;
        results = [];
        for (attr in errors) {
          error = errors[attr];
          if (!error.errors) {
          ...
          results.push(this.validator.showErrors((
            obj = {},
            obj["user[" + attr + "]"] = error.errors[0],
            obj
          )));
        }
        return results;
...
(function() {
  ...
  define('views/user', ['vent'], function(vent) {
    var UserView;
    return UserView = (function(superClass) {
      ...
      UserView.prototype.template = "#templates-user";

      UserView.prototype.templateHelpers = function() {
        return {
          birthday: function(data) {
            if (!data) {
              return;
      ...
      UserView.prototype.edit = function(e) {
        e.preventDefault();
        return vent.trigger("router:navigate", e.currentTarget.pathname);
      };
...
(function() {
  ...
  define('controllers/main', ['views/user', 'views/user/edit', 'vent'], function(UserView, UserEditView, vent) {
    var MainController;
    return MainController = (function(superClass) {
      ...
      MainController.prototype.index = function() {
        ...
        return vent.trigger("layout:content:show", new UserView({
          model: vent.request("user")
        }));
      };

      MainController.prototype.edit = function() {
        return vent.trigger("layout:content:show", new UserEditView({
          model: vent.request("user")
        }));
      };
...
(function() {
  ...
  define('routers/main', ['controllers/main', 'vent'], function(MainController, vent) {
    var MainRouter;
    return MainRouter = (function(superClass) {
      ...
      MainRouter.prototype.controller = new MainController;
      ...
      MainRouter.prototype.initialize = function() {
        return this.listenTo(vent, "router:navigate", this.proxyNavigate);
      };

      MainRouter.prototype.proxyNavigate = function(route) {
...
(function() {
  ...
  define('views/layout', ['vent'], function(vent) {
    var LayoutView;
    return LayoutView = (function(superClass) {
      ...
      LayoutView.prototype.el = "#app";

      LayoutView.prototype.template = "#templates-layout";
      ...
      LayoutView.prototype.initialize = function() {
        return this.listenTo(vent, "layout:content:show", this.showContent);
      };

      LayoutView.prototype.showContent = function(view) {
        return this.getRegion("content").show(view);
      };
...
(function() {
  ...
  require(['views/layout', 'routers/main', 'models/user', 'vent'], function(LayoutView, MainRouter, UserModel, vent) {
    var TestApp;
    TestApp = (function(superClass) {
      ...
      TestApp.prototype.layout = new LayoutView;

      TestApp.prototype.router = new MainRouter;

      TestApp.prototype.onStart = function() {
        var user;
        user = new UserModel(window.appData.user);
        vent.setHandler("user", function() {
          return user;
        });
        this.layout.render();
